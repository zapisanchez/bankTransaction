...
class User extends Component {
    ...
    getDescriptionByName(name){
        ...
        switch(name){
            case 'Rick':
                header = 'Scientific'
                mainText = 
                `Genius scientist whose alcoholism 
            ...
            case 'Bird':
                header = 'Human Bird'
                mainText = 
                `Old friend of Rick's and has seemingly 
            ...
            case 'Abradolf':
                header = 'Experiment'
                mainText = 
                `He was created when Rick combined the DNA 
            ...
            case 'Poopy':
                header = 'Refuge'
                mainText = 
                `Very good friend to the Smith Family, from another dimension `
                subText = 'Oo-wee!'
                break;
    ...
    return(
        this.props.walletList?.map( (key,index)=>{
        return (
        ...
        <Modal trigger={
            ...
            <Modal.Header>{this.props.name}  {this.props.lastName}</Modal.Header>
            <Modal.Content image>
